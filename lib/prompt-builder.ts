...
export const promptTemplates: PromptTemplate[] = [
  ...
  },
  {
    ...
    template: {
      ...
      focalLength: "The scene is depicted with the equivalent of a medium telephoto lens (approximately 35mm–85mm full-frame), creating a cinematic compression effect that enhances subject isolation and intensifies emotional connection.",
